 ...
 *  net.minecraft.server.v1_15_R1.PlayerInteractManager
 *  net.minecraft.server.v1_15_R1.SoundEffect
 *  net.minecraft.server.v1_15_R1.SoundEffectType
 *  net.minecraft.server.v1_15_R1.WorldServer
 *  org.bukkit.Location
 *  org.bukkit.Material
 *  org.bukkit.Sound
 *  org.bukkit.World
...
public class NMSHandler_1_15_R1
extends NMSHandler {
    ...
    public Sound getBlockBreakSound(final Block block) {
        try {
            ...
            final net.minecraft.server.v1_15_R1.Block nmsBlock = nmsWorld.getType(new BlockPosition(block.getX(), block.getY(), block.getZ())).getBlock();
            final SoundEffectType soundEffectType = nmsBlock.getStepSound(nmsBlock.getBlockData());
            final Field breakSound = SoundEffectType.class.getDeclaredField("z");
