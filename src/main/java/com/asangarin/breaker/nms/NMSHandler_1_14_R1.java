 ...
 *  net.minecraft.server.v1_14_R1.EntityPlayer
 *  net.minecraft.server.v1_14_R1.IBlockData
 *  net.minecraft.server.v1_14_R1.MinecraftKey
 *  net.minecraft.server.v1_14_R1.PlayerInteractManager
 *  net.minecraft.server.v1_14_R1.SoundEffect
...
public class NMSHandler_1_14_R1
extends NMSHandler {
    ...
    public Sound getBlockBreakSound(final org.bukkit.block.Block block) {
        try {
            ...
            final Field breakSound = SoundEffectType.class.getDeclaredField("y");
